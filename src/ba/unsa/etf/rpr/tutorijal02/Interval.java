...
public class Interval {
    ...
    public boolean isNull() {
        return (pocetna == 0 && krajnja == 0 && !daLiPocetnaPripadaIntervalu && !daLiKrajnjaPripadaIntervalu);
    }
    ...
    public String toString() {
        ...
        if (this.daLiPocetnaPripadaIntervalu) s = "[";
        else  s = s + "(";
        s = s + this.pocetna + "," + this.krajnja;
        if (this.daLiKrajnjaPripadaIntervalu) s = s + "]";
        else s = s + ")";
        return s;
    }
